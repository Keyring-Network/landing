    ...
    <div id="faq" className={styles.faqWrap}>
      <div className={classNames('container', styles.container)}>
        ...
        <div className={styles.faqAddonsMobile}>
          <h3 className={styles.faqAddon}>{content.FAQ_ADDON}</h3>
          <a href={content.READ_DOCS} className={styles.link} target="_blank" rel="noreferrer">
            <img src={download} alt="download" loading="lazy" />
            {content.DOWNLOAD_DOCS}
          </a>
          <br />
          <a href={content.LINK_DISCORD} className={styles.link} target="_blank" rel="noreferrer">
            <img src={discord} alt="discord" loading="lazy" />
            {content.ASK_DISCORD}
          </a>
        </div>
